  ...
  8 : [function(baseTemp, canCreateDiscussions, a) {
    ...
    !function($) {
      ...
      $(document).ready(function() {
        ...
        $(document).on("MutationObserver", ".widget_shopping_cart_content,.woocommerce-cart-form", function() {
          ...
          scrollElem.trigger("scroll");
        }).on("MutationObserver", "header.header", function() {
        ...
        $("header.header").trigger("MutationObserver");
    ...
    (function($) {
      ...
      function init(self) {
        ...
        if (setTimeout(function() {
          ...
          $("body").on("DOMSubtreeModified", "img", toggle).on("MutationObserver", toggle);
      ...
      $(document).ready(function() {
        ...
        }).on("MutationObserver", ".navbar-action", function() {
          parseFonts();
        }).trigger("MutationObserver"), _wpcom_js.fixed_sidebar && "1" == _wpcom_js.fixed_sidebar && s.length && s.find(".widget").length && $this.width() > 991) {
          /** @type {number} */
          var i = 0;
          for (; i < s.length; i++) {
            init($(s[i]));
